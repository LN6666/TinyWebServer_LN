...
#ifndef MAIN_C_BLOCK_QUEUE_H
#define MAIN_C_BLOCK_QUEUE_H
#include <iostream>
#include <stdlib.h>
#include <pthread.h>
#include <sys/time.h>
...
public:
    ...
    bool pop(T &item)
    {
        ...
        while (m_size <= 0)//当前队列没有元素，线程等待条件变量
        {
            //当重新抢到互斥锁，意味着有元素了，pthread_cond_wait返回为0
